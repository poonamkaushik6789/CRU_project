                    ...
                    <ScrollView  keyboardShouldPersistTaps="handled" persistentScrollbar={true}  style={styles.root}>
                     ...
                     <FlatListSlider
                         ...
                         <View style={{flexDirection:'row',justifyContent:'space-between',marginHorizontal:"3%",marginVertical:20}}>
                                <View style={{width:"65%"}}>
                                <Text style={{fontSize:25,fontWeight:'bold'}}>Pest Control</Text>
                                </View>
                         ...
                         <View style={{backgroundColor:'white',marginVertical:"2%"}}> 
                           <Text style={{fontSize:20,fontWeight:'bold',marginHorizontal:"3%",marginVertical:"2%"}}>Cockroaches, Ants & General Pest Control</Text>
                            <FlatList
                                data={haircutdata}
