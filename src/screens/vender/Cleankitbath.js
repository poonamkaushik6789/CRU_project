...
const Cleankitbath = (props) => {
  ...
  const DATA1 = [
      ...
      const images = [
   {
    image:'https://www.germbustersnyc.com/wp-content/uploads/2019/07/kitchen-1210x723.jpg',
  ...
  const hairdata=[
     ...
     const haircutdata=[
     {
        text1:"Mirror Cleaning", 
     },
      {
        text1:"Ceiling Fan Cleaning", 
     },
      {
        text1:"Window Cleaning", 
     },
     ]
 ...
 const renderItem1 = ({ item ,index }) => {
    ...
    <View >
            <View style={{flexDirection:'row',justifyContent:'space-around',marginHorizontal:18,marginVertical:20}}>
                                    ...
                                    <Text style={{width:'60%',textAlign:'center'}}>{item.text2}</Text>
                                    </View>
                    ...
                    <ScrollView  keyboardShouldPersistTaps="handled" persistentScrollbar={true}  style={styles.root}>
                     ...
                     <FlatListSlider
                         ...
                         <View style={{flexDirection:'row',justifyContent:'space-between',marginHorizontal:"3%",marginVertical:20}}>
                                <View style={{width:"65%"}}>
                                <Text style={{fontSize:25,fontWeight:'bold'}}>Bathroom and Kitchen Cleaning</Text>
                                </View>
                        ...
                        <View style={{backgroundColor:'white',marginVertical:"2%"}}> 
                           <Text style={{fontSize:20,fontWeight:'bold',marginHorizontal:"3%",marginVertical:"2%"}}>Bathroom Cleaning</Text>
                            <FlatList
                                data={Therapydata}
                         ...
                         <View style={{backgroundColor:'white',marginVertical:"2%"}}> 
                           <Text style={{fontSize:20,fontWeight:'bold',marginHorizontal:"3%",marginVertical:"2%"}}>Mini Services</Text>
                            <FlatList
                                data={haircutdata}
