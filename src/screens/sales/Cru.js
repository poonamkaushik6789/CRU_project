    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === "ios" && "padding"} style={styles.root}>
            <ScrollView style={{ paddingBottom: 0, marginTop: 0 }}>
                ...
                <View style={tw`w-53 mx-auto h-15 bg-white mt-5 rounded-3xl border-2 border-sky-400 `}>
                <Text onPress={() => props.navigation.navigate("Viewall")} style={tw`text-center py-4 text-base`}>View All</Text> 
                </View>
                <View style={tw`w-53 mx-auto h-15 bg-white mt-5 rounded-3xl border-2 border-sky-400 mb-15 `}>
