    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === "ios" && "padding"} style={styles.root}>
            <ScrollView style={{ paddingBottom: 0, marginTop: 0 }}>
                <Text style= {tw`mx-auto mt-5 text-sm font-semi-bold`}>Select the dates of your project</Text>
            <View style={tw`bg-[#fff] rounded-lg w-80 mx-auto mt-5`}>
                    <CalendarPicker
                                    ...
                                    <Text style= {tw`mx-auto mt-5 text-sm font-semi-bold`}>tap the areas if you know the location</Text>
                                    <View style={tw`w-80 h-80 bg-white mx-auto mt-5 rounded-lg` }>
                                    <Image  style={tw`mx-auto w-70 h-70 mt-4.5 `}source={ImageIcons.map} /></View>
                                    <Text style= {tw`mx-auto mt-5 text-sm font-semi-bold`}>Select the role you need</Text>
                <View style={tw`bg-[#fff] w-80 mx-auto mt-5 rounded-lg mb-15`}>
