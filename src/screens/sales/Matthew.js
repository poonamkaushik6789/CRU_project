      ...
      <ScrollView style={{ paddingBottom: 0, marginTop: 0 }}>
        <View >
          <View>
            ...
            <View style={tw`w-82 h-75 mx-4 px-4 pt-50 flex-row	justify-between bg-white `} >
            ...
            <TouchableOpacity style={tw`right-10 mt-30 z-60 absolute`} onPress={() => handleupdatebackground()}>
            ...
            <View style={tw`inset-x-39	 mt-33 z-50 absolute`}>
              {props?.getprofilelist?.profileImage != null ?
                <Image source={{ uri: `${Api.imageUri}${props?.getprofilelist?.profileImage}` }} style={tw`w-30 h-30 right-8 rounded-full `} />
                :
                <Image source={ImageIcons.man} style={tw`w-30 h-30 right-8 rounded-full `} />
              }
            </View>
            <TouchableOpacity style={tw`right-28 mt-56 z-50 absolute`} onPress={() => handleupdateprofile()}>
              <Image source={ImageIcons.editclap} style={[tw`w-7 h-7 rounded-full`, { tintColor: '#5fafcf' }]} />
            </TouchableOpacity>
          </View>
