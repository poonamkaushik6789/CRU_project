    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === "ios" && "padding"}style={styles.root}>
            ...
            <ScrollView style={{ paddingBottom: 0 }}>
             ...
             <View style={{margin:'5%'}}>
               <Text style={{fontSize:24,fontWeight:'bold'}}>Air Conditioner repair</Text>
               <Text style={{fontSize:14,color:'#848484',marginTop:'2%'}}>Select your preffered service</Text>
             </View>

             <TouchableOpacity onPress={() => props.navigation.navigate("Aircondition")} style={{flexDirection:'row',marginHorizontal:'7%',marginVertical:'5%'}}>
